...
Scala. Também serão dadas noções do _core_ Hadoop com HDFS, Yarn, além de outras
ferramentas do ecossistema como MapReduce, Sqoop, Hive, Zookeeper e Spark.
Também serão cobertas noções de bancos de dados NoSQL como Cassandra e HBase.
...
#+html: <figcaption>Framwork Agile. Créditos: https://bitsinglass.com/agile-methodologies-enhance-appian-delivery-part-1/</figcaption>
#+html: </figure> </p>

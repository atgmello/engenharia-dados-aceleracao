...
#+html: <figcaption>Tipos de memória. Créditos: <a href="https://medium.com/@esmerycornielle/the-cpu-and-the-memory-2eb300d6c72d"></a>esmerycornielle@medium</figcaption>
#+html: </figure> </p>
...
#+html: <figcaption>Arquitetura do Apache Spark. Créditos: <a href="https://spark.apache.org/docs/2.0.0/cluster-overview.html"></a>Documentação</figcaption>
#+html: </figure> </p>
